...
#define LOCTEXT_NAMESPACE "AngryProceduralDetails"

TSharedRef<IDetailCustomization> FAngryProceduralDetails::MakeInstance()
{
	return MakeShareable(new FAngryProceduralDetails);
}

void FAngryProceduralDetails::CustomizeDetails( IDetailLayoutBuilder& DetailBuilder )
{
	...
	[
		...
		.OnClicked(this, &FAngryProceduralDetails::ClickedOnConvertToStaticMesh)
		.IsEnabled(this, &FAngryProceduralDetails::StaticMeshEnabled)
		.Content()
		[
			SNew(STextBlock)
	...
	.ValueContent()
		...
		.OnClicked(this, &FAngryProceduralDetails::ClickedOnReplaceToStaticMesh)
		.IsEnabled(this, &FAngryProceduralDetails::StaticMeshEnabled)
		.Content()
		[
			SNew(STextBlock)
...
AProceduralActor* FAngryProceduralDetails::GetFirstSelectedProceduralActor() const
{
	// Find first selected valid ProceduralActor
	for (const TWeakObjectPtr<UObject>& Object : SelectedObjectsList)
	{
		AProceduralActor* ProceduralActor = Cast<AProceduralActor>(Object.Get());
...
bool FAngryProceduralDetails::StaticMeshEnabled() const
{
...
UStaticMesh* FAngryProceduralDetails::CreateStaticMesh(AProceduralActor* ProceduralActor)
{
	...
	if (ProceduralMesh != nullptr)
	{
		...
		{
			UE_LOG(AngryProceduralToolsEditor, Error, TEXT("Cannot generate mesh"));
		}
	}
	return nullptr;
}

FReply FAngryProceduralDetails::ClickedOnConvertToStaticMesh()
{
	AProceduralActor* ProceduralActor = GetFirstSelectedProceduralActor();
...
FReply FAngryProceduralDetails::ClickedOnReplaceToStaticMesh()
{
	AProceduralActor* ProceduralActor = GetFirstSelectedProceduralActor();
	if (ProceduralActor != nullptr)
	{
