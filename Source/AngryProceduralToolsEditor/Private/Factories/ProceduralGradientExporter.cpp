...
#include "Factories/ProceduralGradientExporter.h"
...
UProceduralGradientExporterTGA::UProceduralGradientExporterTGA(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{

	SupportedClass = UProceduralGradient::StaticClass();
	PreferredFormatIndex = 0;
	FormatExtension.Add(TEXT("TGA"));
	FormatDescription.Add(TEXT("Targa"));
}

bool UProceduralGradientExporterTGA::SupportsObject(UObject* Object) const
{
	if (Super::SupportsObject(Object))
	{
		UProceduralGradient* Texture = Cast<UProceduralGradient>(Object);
		if (Texture)
		{
			return true;
		}
...
bool UProceduralGradientExporterTGA::ExportBinary(UObject* Object, const TCHAR* Type, FArchive& Ar, FFeedbackContext* Warn, int32 FileIndex, uint32 PortFlags)
{
	/*
	UProceduralGradient* Texture = CastChecked<UProceduralGradient>(Object);
